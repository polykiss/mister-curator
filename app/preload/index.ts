...
import type { ConnectionStatus, Core, MisterProfile, Rom } from '@shared/types';
...
const api: MisterApi = {
  ...
  connect: (profileId: string) => invoke<void>(IPC_CHANNELS.connect, profileId),
  ...
  listCores: () => invoke<Core[]>(IPC_CHANNELS.listCores),
